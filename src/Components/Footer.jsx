    ...
    <div className="lg:max-w-[1200px] m-auto pt-10 pb-10">
      <div className="lg:hidden md:hidden space-y-9 flex flex-wrap  justify-center">
        ...
        <div className="flex space-x-1.5">
          <a
            href="https://www.linkedin.com/in/vladyslav-nechytailo-373b74193/"
            target="_blank"
          >
            <img src={linkdIn} alt="" />
          </a>
          ...
          <a href="https://twitter.com/V_Nechytailo" target="_blank">
            <img src={twitter} alt="" />
          </a>
        </div>

        <p className="uppercase text-dark_blue font-[600] text-sm ">
          <strong>2022</strong> @ copyrights, all right reserved.
        </p>
      </div>
        ...
        <div className="flex space-x-12 items-center">
          ...
          <div className="flex space-x-1.5">
            <a
              ...
              target="_blank"
            >
              <img src={linkdIn} alt="" className="lg:w-[60px]" />
            </a>
            <a href="https://github.com/Nutopia13" target="_blank">
              <img src={github} alt="" className="lg:w-[60px]" />
            </a>
            <a href="https://twitter.com/V_Nechytailo" target="_blank">
              <img src={twitter} alt="" className="lg:w-[60px]" />
            </a>
          </div>
        </div>

        <p className=" mt-24 uppercase text-dark_blue font-[600] text-sm ">
          <strong>2022</strong> @ copyrights, all right reserved.
        </p>
      </div>

      <div className=" hidden lg:hidden md:grid grid-cols-3 items-center max-w-[700px] m-auto">
        <img src={logoMob} loading="lazy" alt="Logo" className="w-[305px]" />
        ...
        <p className=" mt-24 uppercase col-span-2 text-dark_blue font-[600] text-sm ">
          <strong>2022</strong> @ copyrights, all right reserved.
        </p>
