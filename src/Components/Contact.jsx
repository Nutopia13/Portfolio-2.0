  ...
  return (
    <div className="pt-8 lg:pt-16  bg-blue1 overflow-hidden relative">
      <img
        ...
        loading="lazy"
        alt=""
        className="hidden lg:block md:block md:max-w-[80%]  absolute z-10 right-0"
      />
      <div className="mx-auto px-5 max-w-[340px] md:max-w-[700px] lg:max-w-[1200px]">
        <h3 className="contact_title max-w-[1000px]  text-bright_yellow">
          {" "}
          Would you like to discuss{" "}
          <span className="text-white">the project ?</span>
        </h3>
        ...
        <form
          ...
          method="POST"
          className="flex mt-14 flex-col space-y-5 w-fit"
        >
          <input
            type="hidden"
            name="access_key"
          ...
          <button
            type="submit"
            className="btn3 relative z-20 hover:shadow-none ease-in  lg:max-w-[220px] max-w-[170px] duration-75  uppercase font-extrabold text-sm lg:text-lg bg-bright_yellow py-2.5 px-6 lg:py-4 lg:px-9"
          >
            Submit
          </button>
        </form>
        <div className="pt-2 md:pt-6">
          <span className="font-oswald lg:text-xl text-[#13CE66]">
            {result}
          </span>
        </div>
      </div>

      <h3 className="contact_foot lg:hidden md:hidden mt-16 bg-pink text-white py-2 font-bold text-center uppercase">
        - Let's Work Together -{" "}
      </h3>
