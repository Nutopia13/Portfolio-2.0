...
const Portfolio_Component = (props) => {
  return (
    ...
    <div className='lg:ml-28 md:ml-10 max-w-[475px] pl-5 flex flex-wrap flex-col'>
      <div className='img_cont max-w-[325px] max-h-[290px] lg:max-w-[460px] lg:max-h-[460px]'>
        <img src={example} alt="" className='w-full' />
      </div>
      <div className='port_text--cont md:max-w-[300px] lg:max-w-[400px] font-oswald lg:pt-10 pt-6 text-dark_blue text-left '>
